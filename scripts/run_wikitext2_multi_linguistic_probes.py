#!/usr/bin/env python
"""Run heuristic linguistic probes across multiple representations."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        nargs="+",
        required=True,
        help="One or more name=path entries for probe payloads.",
    )
    ...
    parser.add_argument(
        "--output",
        default="outputs/probes/wikitext2_phase4_probe_results.jsonl",
    ...
    tasks = _compute_tasks(first_payload["input_ids"], first_payload["mask"])
